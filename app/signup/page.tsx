...
export default function SignupPage() {
    ...
    return (
      <div className="grain flex min-h-dvh items-center justify-center bg-cream px-5 font-sans text-ink">
        <div className="fade-up w-full max-w-sm">
          ...
          <h1 className="mt-3 font-serif text-4xl">Check your email</h1>
          <p className="mt-4 leading-relaxed text-ink/70">
            We&apos;ve sent you a confirmation link. Click it, then sign in
            and start building your first drop.
          </p>
          <Link
            href="/login"
  ...
  return (
    <div className="grain flex min-h-dvh items-center justify-center bg-cream px-5 font-sans text-ink">
      <form onSubmit={onSubmit} className="fade-up w-full max-w-sm py-10">
        <p className="text-xs font-medium uppercase tracking-[0.3em] text-clay">
          Tour Activation
        </p>
        <h1 className="mt-3 font-serif text-4xl">Get started</h1>
        ...
        <p className="mt-4 text-center text-sm text-ink/60">
          ...
          <Link href="/login" className="font-medium text-clay underline underline-offset-4">
            Sign in
          </Link>
        </p>
      </form>
